...
<div class="w3-main" style="margin-left:250px">
  ...
  foreach($result_set as $path) {
    ...
    echo "<img src = $path[imagePath] height=20% width=20%><div class='w3-display-middle w3-display-hover'><button class='w3-button w3-black'>Trade Now <i class='fa fa-shopping-cart'></i></button></img>";
    echo "</form>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
