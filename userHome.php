...
<div class="w3-main" style="margin-left:250px">
  ...
  foreach($result_set as $path) {
    ...
    echo "<img src = $path[imagePath] height=90% width=90%><input type='hidden' value=$path[username]/><input type='submit' name='receiver' class='w3-button w3-black'>Trade Now</input></img>";
    echo "</form>";
    echo "</div>";
    echo "</div>";
    echo "</div>";
